...
class sellLCForm extends StatefulWidget {
  @override
  _sellLCFormState createState() => _sellLCFormState();
}

class _sellLCFormState extends State<sellLCForm> {
                  ...
                  ElevatedButton(
                    ...
                    onPressed: () {
                      if (_formKey.currentState!.validate()) {
                        ...
                        print('Title: $_name, $_condition, Price: $_price');
